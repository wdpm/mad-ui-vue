...
console.log("process.env.WEBPACK_DEV_SERVER:", process.env.WEBPACK_DEV_SERVER)

module.exports = (env) => {
  const IS_DEV_MDOE = env.development === true || IS_DEV_SERVER
  const IS_PROD_MDOE = env.production === true

  console.log("IS_DEV_MDOE:", IS_DEV_MDOE)
  console.log("IS_PROD_MDOE:", IS_PROD_MDOE)

  return {
    context: path.resolve(process.cwd(), 'website'),

...
!function (a, b) {
    ...
    }, a.prototype.options = {speed: 10, rotate: 0, ease: "Linear", wavesWidth: "95%"}, a.prototype.setupWaveFns = function () {
    ...
    return a.prototype.getDimension = function (a) {
        ...
        var d = a * this.options.speed + (-this.yAxis + b) / c.wavelength, e = c.waveFn.call(this, d, o),
